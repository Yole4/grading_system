...
function AdminAccount() {
    ...
    }, [checkGrade, checkSchoolYear, checkStudentAccount, newStudentChecker, userCredentials]);
                        ...
                        <div className="popup-modal-profile popup-student" style={{ visibility: isAddNewStudent ? 'visible' : 'hidden' }}>
                            <div className="popup-body student-body" onClick={(e) => e.stopPropagation()} style={{ animation: isAddNewStudent ? 'dropBottom .3s linear' : '' }}>
                                ...
                                <form >
                                    ...
                                    <div className="form-control manage-account">
                                        <span>Subject</span>
                                        <select name="" id="" className="form-input manage-account" value={studentInfo.subject} onChange={(e) => setStudentInfo((prev) => ({ ...prev, subject: e.target.value }))} required>
                                    ...
                                    <div className="form-control" style={{ justifyContent: 'space-between', marginTop: '25px', display: 'flex' }}>
                                        ...
                                        <button className='update-button' type='button' onClick={() => studentInfo.grade !== '' && studentInfo.SY !== '' && studentInfo.subject !== '' && studentInfo.teacher !== '' && studentInfo.curriculumn !== '' ? setIsStudentListTableAdd(true) : alert("Please select provided entry!")}>Continue</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                    ...
                                    <form onSubmit={updateStudentInformation} >
                                        <div className="form-container" style={{ display: 'flex', flexWrap: 'wrap', gap: '5%' }}>
                                            ...
                                            <div className="add-student-right m">
                                                ...
                                                <div className="form-control manage-account">
                                                    <span>Subject</span>
                                                    <select name="" id="" className="form-input manage-account" value={updateStudentInfo.subject} onChange={(e) => setUpdateStudentInfo((prev) => ({ ...prev, subject: e.target.value }))} disabled={!isStudentListProfileEdt ? 'disabled' : ''}>
                                                        <option value="" selected disabled>Select Subject</option>
                                                        {listSubject && listSubject.map(item => (
                                                            <option key={item.id} value={item.subject}>{item.subject}</option>
                                                        ))}
